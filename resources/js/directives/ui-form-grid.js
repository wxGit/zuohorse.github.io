...
dbFormGridDirectives.directive('uiFormGrid', ['dbUtils','$timeout', '$window',function (dbUtils,$timeout,$window) {
    return {
        restrict: 'E',
        templateUrl: "../resources/templates/uiFormGrid.html",
        replace: true,
        controller: ['$scope', function ($scope) {
            ...
            if (!autoLoad) {
                $scope.dbFormGrid.loadingTip = "正在候驾中...";
            } else {
                queryData();
            }
            ...
            function queryData() {
                ...
                dbUtils.get($scope.dbFormGrid.options.grid.settings.transCode, queryParams, function (data) {
