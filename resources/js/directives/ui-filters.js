...
var uiFiltersDirectives = angular.module('db.components.uiFilters', ['dbUtils']);

uiFiltersDirectives.uiFiltersCaches = {};//机构树数据缓存对象

uiFiltersDirectives.directive('uiFilters', ['dbUtils','$timeout','$window', function (dbUtils,$timeout,$window) {
    ...
    return {
        restrict: 'E',
        templateUrl: "../resources/templates/uiFilters.html",
        replace: true,
        transclude: true,
