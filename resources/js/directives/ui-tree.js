 ...
 */
'use strict';
var dbTreeDirectives = angular.module('ui.components.tree', ['dbUtils']);
dbTreeDirectives.directive('uiTree', ['dbUtils', '$timeout', function (dbUtils, $timeout) {
    ...
    return {
        restrict: 'E',
        templateUrl: "../resources/templates/uiTree.html",
        replace: true,
