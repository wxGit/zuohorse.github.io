...
'use strict';
var dbGridDirectives = angular.module('ui.components.grid', ['dbUtils']);
dbGridDirectives.directive('uiGrid', ['dbUtils', function (dbUtils) {
    return {
        restrict: 'E',
        templateUrl: "../resources/templates/uiGrid.html",
        replace: true,
        scope: {
            options:'=options',
            params:'=params',
