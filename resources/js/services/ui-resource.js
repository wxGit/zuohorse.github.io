var dbUtils = angular.module("uiUtils",[]);

dbUtils.factory("uiUtils", ["$http", "$window","$q","toaster","$modal", UiFetch]);

function UiFetch($http, $window,$q,toaster,$modal) {
    var promise = false;
    ...
    return {
        ...
        post: function (url, request, success, error) {
        ...
        get: function (url, request,success,error) {

            if(!promise){
                promise = deferred.promise;
            }

            $http.get(url, request).success(function (data, status, headers, config) {
        ...
        put: function (url, request,success,error) {

            if(!promise){
                promise = deferred.promise;
            }

            $http.put(url, request).success(function (data, status, headers, config) {
        ...
        delete: function (url, request,success,error) {

            if(!promise){
                promise = deferred.promise;
            }

            $http.delete(url, request).success(function (data, status, headers, config) {
